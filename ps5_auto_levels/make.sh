...
gcc -O3 -std=c99 auto_levels_ocl.c stb_image.c stb_image_write.c $OCLLIB -o auto_levels_ocl_P${CL_DEVICE} -DCL_DEVICE=$CL_DEVICE -DCL_USE_DEPRECATED_OPENCL_2_0_APIS -lm $1
